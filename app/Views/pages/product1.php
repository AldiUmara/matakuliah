                ...
                <div class="header-navbar">
                    <div class="header-brand">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <img src="<?php base_url() ?>/images/logo/logo-light.png" alt="Site Logo">
                        </a>
                    </div>
                                ...
                                <div class="col-lg-10 order-lg-2">
                                    <div class="single-product-thumbnail-wrap zoom-gallery">
                                        <div class="product-large-thumbnail single-product-thumbnail axil-product">
                                            <div class="thumbnail">
                                                <a href="<?php base_url() ?>/images/product/product-big-04.png"
                                                    class="popup-zoom">
                                                    <img src="<?php base_url() ?>/images/product/product-big-04.png"
                                                        alt="Product Images">
                                                </a>
                                            </div>
                                            <div class="thumbnail">
                                                <a href="<?php base_url() ?>/images/product/product-big-05.png"
                                                    class="popup-zoom">
                                                    <img src="<?php base_url() ?>/images/product/product-big-05.png"
                                                        class="popup-zoom" alt="Product Images">
                                                </a>
                                            </div>
                                            <div class="thumbnail">
                                                <a href="<?php base_url() ?>/images/product/product-big-06.png"
                                                    class="popup-zoom">
                                                    <img src="<?php base_url() ?>/images/product/product-big-06.png"
                                                        class="popup-zoom" alt="Product Images">
                                                </a>
                                            </div>
                                            <div class="thumbnail">
                                                <a href="<?php base_url() ?>/images/product/product-big-08.png"
                                                    class="popup-zoom">
                                                    <img src="<?php base_url() ?>/images/product/product-big-08.png"
                                                        class="popup-zoom" alt="Product Images">
                                                </a>
                                            </div>
                                            <div class="thumbnail">
                                                <a href="<?php base_url() ?>/images/product/product-big-07.png"
                                                    class="popup-zoom">
                                                    <img src="<?php base_url() ?>/images/product/product-big-07.png"
                                                        class="popup-zoom" alt="Product Images">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-2 order-lg-1">
                                    <div class="product-small-thumb small-thumb-wrapper small-thumb-style-two">
                                        <div class="small-thumb-img ">
                                            <img src="<?php base_url() ?>/images/product/product-thumb/thumb-01.png"
                                                alt="thumb image">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="<?php base_url() ?>/images/product/product-thumb/thumb-02.png"
                                                alt="thumb image">
                                        </div>
                                        <div class="small-thumb-img active">
                                            <img src="<?php base_url() ?>/images/product/product-thumb/thumb-03.png"
                                                alt="thumb image">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="<?php base_url() ?>/images/product/product-thumb/thumb-04.png"
                                                alt="thumb image">
                                        </div>
                                        <div class="small-thumb-img">
                                            <img src="<?php base_url() ?>/images/product/product-thumb/thumb-05.png"
                                                alt="thumb image">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-desc-wrapper pt--80 pt_sm--60">
                                        ...
                                        <ul class="pro-des-features pro-desc-style-two pt-10">
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="<?php base_url() ?>/images/product/product-thumb/icon-3.png"
                                                        alt="icon">
                                                </div>
                                                Easy Returns
                                            </li>
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="<?php base_url() ?>/images/product/product-thumb/icon-2.png"
                                                        alt="icon">
                                                </div>
                                                Quality Service
                                            </li>
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="<?php base_url() ?>/images/product/product-thumb/icon-1.png"
                                                        alt="icon">
                                                </div>
                                                Original Product
                                            </li>
                ...
                <div class="recent-product-activation slick-layout-wrapper--15 axil-slick-arrow arrow-top-slide">
                        ...
                        <div class="axil-product">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url() ?>/images/product/electric/product-01.png"
                                        alt="Product Images">
                                </a>
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url() ?>/images/product/electric/product-02.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url() ?>/images/product/electric/product-03.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url() ?>/images/product/electric/product-04.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                    ...
                    <div class="slick-single-layout">
                        <div class="axil-product">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url() ?>/images/product/electric/product-05.png"
                                        alt="Product Images">
                                </a>
                                <div class="label-block label-right">
