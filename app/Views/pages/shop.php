...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2024 13:39:44 GMT -->
<!-- <head>
    <meta charset="utf-8">
    ...
    <!-- Favicon -->
    <!-- <link rel="shortcut icon" type="image/x-icon" href="<?php base_url()?>/images/favicon.png"> -->

    <!-- CSS
    ============================================ -->

    <!-- Bootstrap CSS -->
    <!-- <link rel="stylesheet" href="<?php base_url()?>/css/vendor/bootstrap.min.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/font-awesome.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/flaticon/flaticon.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/slick.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/slick-theme.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/jquery-ui.min.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/sal.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/magnific-popup.css">
    <link rel="stylesheet" href="<?php base_url()?>/css/vendor/base.css">
                        ...
                        <!-- <nav class="mainmenu-nav">
                            ...
                            <ul class="mainmenu">
                                ...
                                <li class="menu-item-has-children">
                                    <a style="color: gold" href="">Beranda</a> -->
                                ...
                                <!-- <li class="menu-item-has-children">
                                    <a style="color: gold"href="#">Product</a>
                                    <ul class="axil-submenu"> -->
                                        <!-- <li><a href="shop-sidebar.html">Shop With Sidebar</a></li> -->
                                        <!-- <li><a  href="<?php base_url()?>">All Products</a></li> -->
                        ...
                        <ul class="action-list">
                            <li class="axil-search">
                                <a href="javascript:void(0)" class="header-search-icon" title="Search">
                                    ...
                                    <i style="color: gold" class="fa-solid fa-magnifying-glass"></i>
                                </a>
                            </li> -->
                            <!-- <li class="wishlist">
                            ...
                            <!-- <li class="shopping-cart">
                                <a href="#" class="cart-dropdown-btn"> -->
                                    ...
                                    <i style="color: gold" class="fa-solid fa-cart-shopping"></i>
                                </a>
                            </li>
                            <li class="my-account">
                                <a href="javascript:void(0)">
                                    <i class="flaticon-person"></i>
                                    <i style="color: gold" class="fa-solid fa-user"></i>
                                </a>
...
<![endif]-->
    ...
    <!-- <header class="header axil-header header-style-5">
        ...
        <div class="axil-mainmenu">
            <div class="container">
                <div class="header-navbar" style='background-color : #1e2a78'>
                    <div class="header-brand">
                        <a href="index.html" class="logo logo-dark">
                            <img src="<?php base_url()?>/images/logo/logo_thrift.png" alt="Site Logo">
                        </a>
                        <a href="index.html" class="logo logo-light">
                            <img src="<?php base_url()?>/images/logo/logo-title.png" alt="Site Logo">
                        </a>
                    </div>
                    <div class="header-main-nav"> -->
                        <!-- Start Mainmanu Nav -->
                        <!-- <nav class="mainmenu-nav">
                            ...
                            <div class="mobile-nav-brand">
                                <a href="index.html" class="logo">
                                    <img src="<?php base_url()?>/images/logo/logo.png" alt="Site Logo">
                                </a>
                            </div>
                            <ul class="mainmenu">
                                <li class="menu-item-has-children">
                                    <a href="#" style='color : gold'>Beranda</a> -->
                                    <!-- <ul class="axil-submenu">
                                        <li><a href="index-1.html">Home - Electronics</a></li>
                                        <li><a href="index-2.html">Home - NFT</a></li>
                                        <li><a href="index-3.html">Home - Fashion</a></li>
                                ...
                                <!-- <li class="menu-item-has-children">
                                    <a href="#" style="color : gold">Shop</a>
                                    <ul class="axil-submenu"> -->
                                        <!-- <li><a href="shop-sidebar.html">Shop With Sidebar</a></li> -->
                                        <!-- <li><a href="<?php base_url()?>Shop.html">All Produk</a></li> -->
                                        <!-- <li><a href="single-product.html">Product Variation 1</a></li>
                                        <li><a href="single-product-2.html">Product Variation 2</a></li>
                                        <li><a href="single-product-3.html">Product Variation 3</a></li>
                                        <li><a href="single-product-4.html">Product Variation 4</a></li>
                                ...
                                <!-- <li><a href="contact.html" style='color : gold'>Contact</a></li>
                            </ul>
                        </nav> -->
                        <!-- End Mainmanu Nav -->
                    <!-- </div>
                    ...
                    <div class="col-lg-6 col-md-4">
                        <div class="inner">
                            <div class="bradcrumb-thumb">
                                <img src="<?php base_url()?>/images/logo/logo_titel.png" width="120px" height="auto" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row--15">
                        ...
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-16.png" alt="Product Images">
                                </a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-17.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-18.png" alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-21.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a></li>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <div class="product-price-variant">
                                        <span class="price current-price">Rp 60.000</span>
                ...
                <div class="row row--15">
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/kacamata/product-big-04.png" alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% OFF</div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/kacamata/product-big-05.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/kacamata/product-big-06.png" alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">30% OFF</div>
                                </div>
                ...
                <div class="row row--15">
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-13.png" alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% OFF</div>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    <h5 class="title"><a href="single-product.html">G-SHOCK GDW5640</a></h5>
                                    <div class="product-price-variant">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-25.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a></li>
                ...
                <div class="row row--15">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-24.png" alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% OFF</div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-36.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <!-- <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-9.png" alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% OFF</div>
                                </div>
                    ...
                    <!-- <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-10.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a></li>
                    ...
                    <!-- <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-11.png" alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">30% OFF</div>
                                </div>
                    ...
                    <!-- <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="axil-product product-style-one has-color-pick mt--40">
                            <div class="thumbnail">
                                <a href="single-product.html">
                                    <img src="<?php base_url()?>/images/product/fashion/product-12.png" alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="wishlist"><a href="wishlist.html"><i class="far fa-heart"></i></a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4 col-lg-12">
                        <div class="copyright-left d-flex flex-wrap justify-content-center">
                            <ul class="quick-link">
                                <li>© 2024. All rights reserved by <a target="" href="">Thrift Family</a>.</li>
                            </ul>
                        </div>
                    </div> -->
                    <!-- <div class="col-xl-4 col-lg-12">
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2024 13:39:45 GMT -->
<!-- </html> -->