                    ...
                    <div class="row row--30">
                        <div class="col-lg-8">
                            <div class="contact-form">
                                ...
                                <p>Jika Anda memiliki produk hebat yang Anda buat atau ingin bekerja sama dengan kami, hubungi kami.</p>
                                    ...
                                    <div class="row row--10">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb--0">
                                                <button name="submit" type="submit" id="submit" class="axil-btn btn-bg-primary">Kirim Pesan</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="col-lg-4">
                            <div class="contact-location mb--40">
                                ...
                                <span class="email">Email: thriffamily@gmail.com</span>
                            </div>
                            <div class="contact-career mb--40">
                                <h4 class="title mb--20">Karier</h4>
